# nvim-treesitter-queries-problog

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-problog/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-problog/actions/workflows/validate.yml)

Neovim tree-sitter queries for **problog**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-problog",
...
- [ ] Changes are scoped to `problog` — do not include files for other languages
